...
pe "az vm create --resource-group ansible-n-azure --name ansible-test-vm1 --image UbuntuLTS --generate-ssh-keys > /dev/null"
p "# And we'll create one machine with a tag."
pe "az vm create --resource-group ansible-n-azure --name ansible-test-vm2 --image UbuntuLTS --tags nginx --generate-ssh-keys > /dev/null"
p ""
p ""
